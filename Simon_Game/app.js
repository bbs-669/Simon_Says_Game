...
// btns[0].addEventListener('mouseup',()=>{
//         btns[0].style.background='#c20c51';
//     });

// btns[1].addEventListener('mouseup',()=>{
//         btns[1].style.background='#04827c';
//     });

// btns[2].addEventListener('mouseup',()=>{
//         btns[2].style.background='#f2993f';
//     });

// btns[3].addEventListener('mouseup',()=>{
//         btns[3].style.background='#6a93e6';
//     });